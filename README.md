...
Getting a [TOTP](https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm) Token (called `secret` by Google Authenticator)
...
9. Copy that long token of random letters and numbers
