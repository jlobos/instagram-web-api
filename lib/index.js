...
class Instagram {
  ...
  async getPhotosByUsername({ username, first, after }) {
    ...
    return this.getUserIdPhotos({ id: userId, first, after })
  }
  ...
  async getFollowersId({ userId }) {
    ...
    let list=[];
    let followers= await this.getFollowers({ userId ,first:100,after:''});        
    let data=followers.data;
  ...
  async getFollowersUsername({ userId }) {
  ...
  async getFollowingsId({userId}){

    let list=[];
    let followings= await this.getFollowings({ userId ,first:100,after:''});
      
    let data=followings.data;
  ...
  async getFollowingsUsername({userId}){
